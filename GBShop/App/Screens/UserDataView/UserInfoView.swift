...
final class UserInfoView: UIView {
    ...
    private func setupPullDownMenu() {
        ...
        if UserSession.instance.user.gender == "Male" {
            ...
            genderButton.menu = UIMenu(children: [
                UIAction(title: "Male", handler:
                            genderClosure),
                UIAction(title: "Female", state: .on, handler: genderClosure)
            ])
        }
    ...
    @objc func conformButtonTapped(sender: UIButton) {
        ...
        if canEdited {
            ...
            let currentUser = User(id: UserSession.instance.user.id,
                                   ...
                                   bio: bio)
            userInfoViewController?.presenter?.changeUserInfo(userInfo: currentUser)
        } else {
            canEdited = true
        }
